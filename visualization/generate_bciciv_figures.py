...
def plot_system_block_diagram(output_dir: Path, formats: tuple[str, ...]) -> list[Path]:
    ...
    calibration_boxes = [
        ...
        ("ProjectionLibrary\ncurrent baseline:\n32 x (2 x 8)", 8.15, 5.12, 2.35, 0.95, "#fef08a"),
    ...
    online_boxes = [
        ...
        ("Candidate weights\nbaseline W shape\n(32,2,8)", 5.75, 2.65, 2.25, 1.0, "#fef3c7"),
        ("MVMBackend.scan\ncontract: (N,M,D)\ncurrent return: (32,2)", 8.35, 2.65, 2.4, 1.0, "#fdba74"),
    ...
    _rounded_box(
        ...
        2.85,
        0.82,
        "Photonic primitive\n2 x 8 tile, not limit\nlarger M x D by tiling",
        "#ffedd5",
        edge="#ea580c",
        fontsize=7.7,
    )
    _rounded_box(
        ...
        2.35,
        0.82,
        "Hardware backend hides\ntile schedule, partial sums,\nreadout/correction",
        "#fff7ed",
        edge="#ea580c",
        fontsize=7.6,
    )
    ...
    _rounded_box(
        ...
        6.45,
        0.72,
        "Algorithm summary\nCurrent baseline: CAR + 8-30 Hz + log-bandpower, not CSP\n2 x 8 is the chosen projection shape here; larger matrices can use tiled MVM",
        "#ffffff",
        edge="#64748b",
        fontsize=7.1,
    )
